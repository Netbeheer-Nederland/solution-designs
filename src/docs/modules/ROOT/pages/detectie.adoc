...
|ID |Als rol |Wil ik |Want
 ...
 |{counter:fe} 
 |Derde
 |Een uniform overzicht van de aanwezigheid en het geschatte piekvermogen, met een _Confidence Level_,  van energie-intensieve apparaten (PV, EV, WP en BESS) achter een transformator, geaggregeerd op PC6
a|
...
* Als brandweer wil ik weten waar thuisbatterijen een verhoogd risico zijn.
 ...
 |{counter:fe} 
 |Derde
 |Een uniform overzicht van de aanwezigheid en het geschatte piekvermogen, met een _Confidence Level_,  van energie-intensieve apparaten (PV, EV, WP en BESS) achter een transformator, geaggregeerd op transformator
